...
public class ValueArmLeft : MonoBehaviour
{
    ...
    void Update()
    {
       ...
       lowArmPronateL = Hand.transform.localRotation.x;

       upArmRotateL = ForeArm.transform.localRotation.y;

       HandFlexationHelper = Finger.transform.position-Hand.transform.position;
       HandFlexationHelper.x = 0;
       handFlexL = Vector3.Angle(HandFlexationHelper, Hand.transform.localPosition);
